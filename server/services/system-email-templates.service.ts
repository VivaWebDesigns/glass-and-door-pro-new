...
export const SYSTEM_EMAIL_TEMPLATE_DEFAULTS: InsertEmailTemplate[] = [
  ...
  },
  {
    ...
    {{#replyToEmail}}<table cellpadding="0" cellspacing="0" style="margin:24px 0;">
      <tr><td style="background:#1e3a5f;border-radius:6px;padding:12px 28px;">
        <a href="mailto:{{replyToEmail}}" style="color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;">Reply to {{senderName}}</a>
      </td></tr>
    </table>{{/replyToEmail}}`,
    ),
  },
